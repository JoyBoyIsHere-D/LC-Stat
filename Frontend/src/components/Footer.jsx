    ...
    return (
        <div className="text-center mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-gray-200 dark:border-gray-700">
            ...
            <div className="flex justify-center items-center gap-6 mt-4">
                <a
                    href="https://github.com/JoyBoyIsHere-D/LC-Stat"
                    target="_blank"
                ...
                <a
                    href="https://www.linkedin.com/in/jayanshu-jena-289a77286/"
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            {!authUser && (
                <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm mt-4 px-4">
